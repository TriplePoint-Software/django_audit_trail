...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('audit_trail_audittrail', (
            ...
            ('json_values', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('audit_trail', ['AuditTrail'])


    def backwards(self, orm):
        # Deleting model 'AuditTrail'
        db.delete_table('audit_trail_audittrail')
